...
impl Cpu {
    ...
    fn exec_dispatcher(&mut self, mem: &mut Mmu, opcode: u16) -> u8 {
        match opcode {
            ...
            // RET
            0xC9 => { ret(mem, get_mut_pc!(self), get_mut_sp!(self)); return 2; },
            0xC0 => { ret_nz(mem, get_f!(self), get_mut_pc!(self), get_mut_sp!(self)); return 2; },
            0xC8 => { ret_z(mem, get_f!(self), get_mut_pc!(self), get_mut_sp!(self)); return 2; },
            0xD0 => { ret_nc(mem, get_f!(self), get_mut_pc!(self), get_mut_sp!(self)); return 2; },
            0xD8 => { ret_c(mem, get_f!(self), get_mut_pc!(self), get_mut_sp!(self)); return 2; },
            ...
            0xCB01 => { rlc_reg(get_mut_c!(self), get_mut_f!(self)); return 2; },
            0xCB02 => { rlc_reg(get_mut_d!(self), get_mut_f!(self)); return 2; },
            ...
            0xCB09 => { rrc_reg(get_mut_c!(self), get_mut_f!(self)); return 2; },
            0xCB0A => { rrc_reg(get_mut_d!(self), get_mut_f!(self)); return 2; },
            ...
            0xCB11 => { rl_reg(get_mut_c!(self), get_mut_f!(self)); return 2; },
            0xCB12 => { rl_reg(get_mut_d!(self), get_mut_f!(self)); return 2; },
            ...
            0xCB19 => { rr_reg(get_mut_c!(self), get_mut_f!(self)); return 2; },
            0xCB1A => { rr_reg(get_mut_d!(self), get_mut_f!(self)); return 2; },
            ...
            0xCB21 => { sla_reg(get_mut_c!(self), get_mut_f!(self)); return 2; },
            0xCB22 => { sla_reg(get_mut_d!(self), get_mut_f!(self)); return 2; },
            ...
            0xCB29 => { sra_reg(get_mut_c!(self), get_mut_f!(self)); return 2; },
            0xCB2A => { sra_reg(get_mut_d!(self), get_mut_f!(self)); return 2; },
            ...
            0xCB39 => { srl_reg(get_mut_c!(self), get_mut_f!(self)); return 2; },
            0xCB3A => { srl_reg(get_mut_d!(self), get_mut_f!(self)); return 2; },
