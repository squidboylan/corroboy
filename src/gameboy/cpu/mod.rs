...
impl Cpu {
    ...
    fn exec_dispatcher(&mut self, mem: &mut Mmu, opcode: u16) -> u8 {
        match opcode {
            ...
            0xCB47 => return bit_0_a!(self),
            0xCB4F => return bit_1_a!(self),
            0xCB57 => return bit_2_a!(self),
            0xCB5F => return bit_3_a!(self),
            0xCB67 => return bit_4_a!(self),
            0xCB6F => return bit_5_a!(self),
            0xCB77 => return bit_6_a!(self),
            0xCB7F => return bit_7_a!(self),

            0xCB40 => return bit_0_b!(self),
            0xCB48 => return bit_1_b!(self),
            0xCB50 => return bit_2_b!(self),
            0xCB58 => return bit_3_b!(self),
            0xCB60 => return bit_4_b!(self),
            0xCB68 => return bit_5_b!(self),
            0xCB70 => return bit_6_b!(self),
            0xCB78 => return bit_7_b!(self),

            0xCB41 => return bit_0_c!(self),
            0xCB49 => return bit_1_c!(self),
            0xCB51 => return bit_2_c!(self),
            0xCB59 => return bit_3_c!(self),
            0xCB61 => return bit_4_c!(self),
            0xCB69 => return bit_5_c!(self),
            0xCB71 => return bit_6_c!(self),
            0xCB79 => return bit_7_c!(self),

            0xCB42 => return bit_0_d!(self),
            0xCB4A => return bit_1_d!(self),
            0xCB52 => return bit_2_d!(self),
            0xCB5A => return bit_3_d!(self),
            0xCB62 => return bit_4_d!(self),
            0xCB6A => return bit_5_d!(self),
            0xCB72 => return bit_6_d!(self),
            0xCB7A => return bit_7_d!(self),

            0xCB43 => return bit_0_e!(self),
            0xCB4B => return bit_1_e!(self),
            0xCB53 => return bit_2_e!(self),
            0xCB5B => return bit_3_e!(self),
            0xCB63 => return bit_4_e!(self),
            0xCB6B => return bit_5_e!(self),
            0xCB73 => return bit_6_e!(self),
            0xCB7B => return bit_7_e!(self),

            0xCB44 => return bit_0_h!(self),
            0xCB4C => return bit_1_h!(self),
            0xCB54 => return bit_2_h!(self),
            0xCB5C => return bit_3_h!(self),
            0xCB64 => return bit_4_h!(self),
            0xCB6C => return bit_5_h!(self),
            0xCB74 => return bit_6_h!(self),
            0xCB7C => return bit_7_h!(self),

            0xCB45 => return bit_0_l!(self),
            0xCB4D => return bit_1_l!(self),
            0xCB55 => return bit_2_l!(self),
            0xCB5D => return bit_3_l!(self),
            0xCB65 => return bit_4_l!(self),
            0xCB6D => return bit_5_l!(self),
            0xCB75 => return bit_6_l!(self),
            0xCB7D => return bit_7_l!(self),

            0xCB46 => return bit_0_hl_val!(self, mem),
            0xCB4E => return bit_1_hl_val!(self, mem),
            0xCB56 => return bit_2_hl_val!(self, mem),
            0xCB5E => return bit_3_hl_val!(self, mem),
            0xCB66 => return bit_4_hl_val!(self, mem),
            0xCB6E => return bit_5_hl_val!(self, mem),
            0xCB76 => return bit_6_hl_val!(self, mem),
            0xCB7E => return bit_7_hl_val!(self, mem),

            0xCB87 => return res_0_a!(self),
            0xCB8F => return res_1_a!(self),
            0xCB97 => return res_2_a!(self),
            0xCB9F => return res_3_a!(self),
            0xCBA7 => return res_4_a!(self),
            0xCBAF => return res_5_a!(self),
            0xCBB7 => return res_6_a!(self),
            0xCBBF => return res_7_a!(self),

            0xCB80 => return res_0_b!(self),
            0xCB88 => return res_1_b!(self),
            0xCB90 => return res_2_b!(self),
            0xCB98 => return res_3_b!(self),
            0xCBA0 => return res_4_b!(self),
            0xCBA8 => return res_5_b!(self),
            0xCBB0 => return res_6_b!(self),
            0xCBB8 => return res_7_b!(self),

            0xCB81 => return res_0_c!(self),
            0xCB89 => return res_1_c!(self),
            0xCB91 => return res_2_c!(self),
            0xCB99 => return res_3_c!(self),
            0xCBA1 => return res_4_c!(self),
            0xCBA9 => return res_5_c!(self),
            0xCBB1 => return res_6_c!(self),
            0xCBB9 => return res_7_c!(self),

            0xCB82 => return res_0_d!(self),
            0xCB8A => return res_1_d!(self),
            0xCB92 => return res_2_d!(self),
            0xCB9A => return res_3_d!(self),
            0xCBA2 => return res_4_d!(self),
            0xCBAA => return res_5_d!(self),
            0xCBB2 => return res_6_d!(self),
            0xCBBA => return res_7_d!(self),

            0xCB83 => return res_0_e!(self),
            0xCB8B => return res_1_e!(self),
            0xCB93 => return res_2_e!(self),
            0xCB9B => return res_3_e!(self),
            0xCBA3 => return res_4_e!(self),
            0xCBAB => return res_5_e!(self),
            0xCBB3 => return res_6_e!(self),
            0xCBBB => return res_7_e!(self),

            0xCB84 => return res_0_h!(self),
            0xCB8C => return res_1_h!(self),
            0xCB94 => return res_2_h!(self),
            0xCB9C => return res_3_h!(self),
            0xCBA4 => return res_4_h!(self),
            0xCBAC => return res_5_h!(self),
            0xCBB4 => return res_6_h!(self),
            0xCBBC => return res_7_h!(self),

            0xCB85 => return res_0_l!(self),
            0xCB8D => return res_1_l!(self),
            0xCB95 => return res_2_l!(self),
            0xCB9D => return res_3_l!(self),
            0xCBA5 => return res_4_l!(self),
            0xCBAD => return res_5_l!(self),
            0xCBB5 => return res_6_l!(self),
            0xCBBD => return res_7_l!(self),

            0xCB86 => return res_0_hl_val!(self, mem),
            0xCB8E => return res_1_hl_val!(self, mem),
            0xCB96 => return res_2_hl_val!(self, mem),
            0xCB9E => return res_3_hl_val!(self, mem),
            0xCBA6 => return res_4_hl_val!(self, mem),
            0xCBAE => return res_5_hl_val!(self, mem),
            0xCBB6 => return res_6_hl_val!(self, mem),
            0xCBBE => return res_7_hl_val!(self, mem),

            0xCBC7 => return set_0_a!(self),
            0xCBCF => return set_1_a!(self),
            0xCBD7 => return set_2_a!(self),
            0xCBDF => return set_3_a!(self),
            0xCBE7 => return set_4_a!(self),
            0xCBEF => return set_5_a!(self),
            0xCBF7 => return set_6_a!(self),
            0xCBFF => return set_7_a!(self),

            0xCBC0 => return set_0_b!(self),
            0xCBC8 => return set_1_b!(self),
            0xCBD0 => return set_2_b!(self),
            0xCBD8 => return set_3_b!(self),
            0xCBE0 => return set_4_b!(self),
            0xCBE8 => return set_5_b!(self),
            0xCBF0 => return set_6_b!(self),
            0xCBF8 => return set_7_b!(self),

            0xCBC1 => return set_0_c!(self),
            0xCBC9 => return set_1_c!(self),
            0xCBD1 => return set_2_c!(self),
            0xCBD9 => return set_3_c!(self),
            0xCBE1 => return set_4_c!(self),
            0xCBE9 => return set_5_c!(self),
            0xCBF1 => return set_6_c!(self),
            0xCBF9 => return set_7_c!(self),

            0xCBC2 => return set_0_d!(self),
            0xCBCA => return set_1_d!(self),
            0xCBD2 => return set_2_d!(self),
            0xCBDA => return set_3_d!(self),
            0xCBE2 => return set_4_d!(self),
            0xCBEA => return set_5_d!(self),
            0xCBF2 => return set_6_d!(self),
            0xCBFA => return set_7_d!(self),

            0xCBC3 => return set_0_e!(self),
            0xCBCB => return set_1_e!(self),
            0xCBD3 => return set_2_e!(self),
            0xCBDB => return set_3_e!(self),
            0xCBE3 => return set_4_e!(self),
            0xCBEB => return set_5_e!(self),
            0xCBF3 => return set_6_e!(self),
            0xCBFB => return set_7_e!(self),

            0xCBC4 => return set_0_h!(self),
            0xCBCC => return set_1_h!(self),
            0xCBD4 => return set_2_h!(self),
            0xCBDC => return set_3_h!(self),
            0xCBE4 => return set_4_h!(self),
            0xCBEC => return set_5_h!(self),
            0xCBF4 => return set_6_h!(self),
            0xCBFC => return set_7_h!(self),

            0xCBC5 => return set_0_l!(self),
            0xCBCD => return set_1_l!(self),
            0xCBD5 => return set_2_l!(self),
            0xCBDD => return set_3_l!(self),
            0xCBE5 => return set_4_l!(self),
            0xCBED => return set_5_l!(self),
            0xCBF5 => return set_6_l!(self),
            0xCBFD => return set_7_l!(self),

            0xCBC6 => return set_0_hl_val!(self, mem),
            0xCBCE => return set_1_hl_val!(self, mem),
            0xCBD6 => return set_2_hl_val!(self, mem),
            0xCBDE => return set_3_hl_val!(self, mem),
            0xCBE6 => return set_4_hl_val!(self, mem),
            0xCBEE => return set_5_hl_val!(self, mem),
            0xCBF6 => return set_6_hl_val!(self, mem),
            0xCBFE => return set_7_hl_val!(self, mem),
